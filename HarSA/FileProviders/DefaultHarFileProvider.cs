...
namespace HarSA.FileProviders
{
    public class DefaultHarFileProvider : PhysicalFileProvider, IAppFileProvider
    {
        public DefaultHarFileProvider(string root) : base(root)
        {
        }
